...
export const Savings: React.FC = () => {
  const [selectedGoal] = useState<string | null>(null);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-emerald-50/30 dark:from-slate-900 dark:via-blue-900/20 dark:to-slate-900">
      {/* Hero Section */}
          ...
          >
            ...
            <div className="text-center space-y-4 sm:space-y-6 lg:space-y-8">
              <div className="relative inline-block">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 bg-clip-text text-transparent mb-2 sm:mb-4 leading-tight px-2">
                  Mis Ahorros
                </h1>
                <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-4 h-4 sm:w-6 sm:h-6 bg-emerald-500 rounded-full animate-pulse-slow border-2 border-white dark:border-slate-900"></div>
              </div>
              <p className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl sm:max-w-3xl mx-auto leading-relaxed px-4">
            ...
            {/* Navegación por pestañas moderna - Responsive */}
            <div className="flex justify-center px-4">
              <div className="flex flex-col sm:flex-row bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-1 sm:p-2 space-y-1 sm:space-y-0 sm:space-x-2 border border-slate-200 dark:border-slate-700 shadow-lg w-full max-w-md sm:max-w-none">
                <Button
                  variant={activeTab === 'goals' ? 'default' : 'ghost'}
                  size="sm"
                  onClick={() => setActiveTab('goals')}
                  className={`rounded-lg sm:rounded-xl transition-all duration-300 flex-1 sm:flex-none ${
                    activeTab === 'goals' 
                ...
                >
                  ...
                  <span className="text-sm sm:text-base">Metas ({activeGoals.length})</span>
                </Button>
                <Button
                ...
                >
                  ...
                  <span className="text-sm sm:text-base">Estrategias ({mockStrategies.length})</span>
                </Button>
                <Button
                ...
                >
                  <Lightbulb className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3" />
                  <span className="text-sm sm:text-base">Insights ({mockInsights.length})</span>
                </Button>
              </div>
            </div>
          </motion.div>
      ...
      <AnimatePresence mode="wait">
        {activeTab === 'goals' && (
          ...
          >
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-300">Total Ahorrado</span>
                      </div>
                      <Eye className="w-3 h-3 sm:w-4 sm:h-4 text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity" />
                    </div>
                    <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-2">${totalCurrent.toLocaleString()}</p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0 px-4 sm:px-0">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="rounded-lg text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-700 text-xs sm:text-sm"
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    className="rounded-lg bg-blue-500/20 text-blue-600 dark:text-blue-400 border border-blue-500/30 text-xs sm:text-sm"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 px-4 sm:px-0">
          ...
          >
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-emerald-500/20 to-emerald-400/20 rounded-xl flex items-center justify-center">
                <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 dark:text-emerald-400" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white">Estrategias Activas ({mockStrategies.length})</h3>
            </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 space-y-3 sm:space-y-0">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">Mis Metas de Ahorro</h3>
              ...
              <Button
                ...
                className="flex items-center space-x-2 bg-slate-700/50 border-slate-600/50 text-white hover:bg-slate-600/50 text-xs sm:text-sm"
                        ...
                        <CardHeader className="pb-3">
                          <div className="flex items-start justify-between">
                            <div className="flex items-center space-x-2 sm:space-x-3">
                              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-emerald-500/20 to-blue-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                {getCategoryIcon(goal.category)}
                              </div>
                        ...
                        <CardContent className="space-y-4 sm:space-y-6">
                          <div className="space-y-2 sm:space-y-3">
                            <div className="flex justify-between items-center">
                              <span className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-400">Progreso</span>
                              <span className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">{progress.toFixed(1)}%</span>
                            </div>
                          ...
                          <div className="grid grid-cols-2 gap-3 sm:gap-4">
                            <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 rounded-xl p-2 sm:p-3 border border-emerald-200 dark:border-emerald-800">
                              <p className="text-xs font-medium text-emerald-700 dark:text-emerald-300 mb-1">Ahorrado</p>
                              <p className="text-sm sm:text-lg font-bold text-emerald-900 dark:text-emerald-100">${goal.current.toLocaleString()}</p>
                            </div>
                            <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-2 sm:p-3 border border-blue-200 dark:border-blue-800">
                              <p className="text-xs font-medium text-blue-700 dark:text-blue-300 mb-1">Meta</p>
                              <p className="text-sm sm:text-lg font-bold text-blue-900 dark:text-blue-100">${goal.target.toLocaleString()}</p>
                            </div>
                          </div>
